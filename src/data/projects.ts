...
export const projects: Project[] = [
  ...
  },
  {
    ...
    status: "Концепт",
    description:
      "Кухня-гостиная 31,8 м² в частном доме в селе Урожайное стала отражением уникальных увлечений заказчиков: пространство выполнено в стиле современной классики, где эстетика молдингов и паркета «ёлочка» сочетается с атмосферой настоящего творческого ретрита. " +
