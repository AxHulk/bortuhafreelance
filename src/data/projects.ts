...
import gagKitImg01 from "@/assets/portfolio/gagarinsky-kitchen/01-patagonia-marble-overview.jpg";
import gagKitImg02 from "@/assets/portfolio/gagarinsky-kitchen/02-work-zone-hood.jpg";
import gagKitImg03 from "@/assets/portfolio/gagarinsky-kitchen/03-bar-chandelier.jpg";
import gagKitImg04 from "@/assets/portfolio/gagarinsky-kitchen/04-bar-top-view.jpg";
import gagKitImg05 from "@/assets/portfolio/gagarinsky-kitchen/05-birds-concept-link.jpg";
...
export const projects: Project[] = [
  ...
  {
    id: "urozhaynoe-bathroom",
    objectId: "urozhaynoe-house",
    title: "Санузел",
    area: "",
    location: "Урожайное",
    year: "Сдан в мае 2026",
    style: "Современная классика с изумрудным акцентом: оникс, тёмно-зелёная «ёлочка» и тёплый орех",
    category: "residential",
    task: "Создать совмещённый санузел с ванной и душевой, в котором соединились бы благородство ониксовой плитки, графичная глубина изумрудной «ёлочки» и тёплая фактура ореха. Сохранить эргономику небольшого помещения, выделить душевую как самостоятельную зону и поддержать общую неоклассическую стилистику дома.",
    status: "Реализован",
    description:
      "Санузел в частном доме за городом продолжает линию современной классики, заданную в кухне-гостиной и спальне, но переводит её в более камерный, спа-сценарий. Главная идея — собрать в одном пространстве три равноправных материала: тёплый онитовый камень, глубокую изумрудную «ёлочку» и шоколадный орех — и сбалансировать их графичной чёрно-белой геометрией пола. " +
      "Стены облицованы крупноформатной плиткой под оникс с тёплыми золотистыми прожилками — она работает как «фон» для всей композиции и наполняет помещение мягким светом даже при выключенной подсветке. На контрасте — акцентные плоскости, выложенные глянцевой ручной плиткой глубокого изумрудного цвета в раскладке «ёлочка». Эти зелёные «панно» обозначают функциональные зоны: стену за ванной, перегородку с зеркалом над тумбой и фартук душевой. " +
      "Ванна установлена в нише на деревянном подиуме из брашированного дуба — он визуально приподнимает зону и связывает санузел с полом основных помещений дома. Над нишей спрятана тёплая LED-подсветка карниза: вечером она превращает зону купания в мягко светящийся «фонарь». Душевая выделена в отдельный объём с чёрной фурнитурой и стеклянной перегородкой в тонком чёрном профиле — внутри тот же изумрудный «ёлочный» рисунок и душевая система графитового цвета. " +
      "Для умывальника выбрана подвесная тумба из ореха с филёнчатыми фасадами и накладной столешницей из искусственного камня — отсылка к классической мебели, которая мягко контрастирует с глянцем плитки. Над ней — фигурное зеркало в тонкой металлической рамке и каскад тонких подвесных светильников вместо привычного бра: они задают вертикальный ритм и работают как ювелирное украшение стены. " +
      "Зону инсталляции с подвесным унитазом мы спрятали за встроенным шкафом во всю высоту из того же ореха: он принимает на себя весь скрытый сторадж — от бытовой химии до текстиля, поэтому открытые поверхности остаются графичными и спокойными. Пол выложен классической чёрно-белой октагональной плиткой с маленькими ромбами — небольшой исторический акцент, который добавляет интерьеру характера и поддерживает неоклассическую интонацию. " +
      "Вся сантехника, фурнитура и аксессуары выдержаны в матовой чёрной палитре, а свет распределён по сценариям: верхние точечные светильники для общего освещения, скрытая LED-подсветка карниза и подвесы у зеркала для вечерних спа-ритуалов. В результате — компактный, но насыщенный санузел, в котором ежедневная функциональность подана с интонацией дорогого бутик-отеля.",
    coverGradient: "from-primary/20 to-secondary/25",
    coverImage: urozhBathImg01,
    gallery: [
      { src: urozhBathImg01, alt: "Общий вид санузла: ниша с ванной, изумрудная «ёлочка», ореховый шкаф и зона умывальника с фигурным зеркалом" },
      { src: urozhBathImg02, alt: "Зона ванны и вход в душевую: онитовая плитка, чёрные смесители и стеклянная перегородка в тонком профиле" },
      { src: urozhBathImg03, alt: "Душевая зона крупным планом: изумрудная «ёлочка», тропический душ и графитовая душевая стойка" },
      { src: urozhBathImg04, alt: "Ванна на деревянном подиуме, подсветка карниза и подвесной унитаз на фоне ониксовых панелей" },
      { src: urozhBathImg05, alt: "Фронтальный вид душевой: акцентная стена из изумрудной «ёлочки», чёрная стойка и трап в полу" },
      { src: urozhBathImg06, alt: "Зона умывальника: ореховая тумба, фигурное зеркало и каскад тонких подвесов на фоне зелёной «ёлочки»" },
      { src: urozhBathImg07, alt: "Высокий шкаф из ореха, скрывающий инсталляцию, и зона унитаза на октагональной чёрно-белой плитке" },
    ],
  },
  {
    id: "gagarinsky-living-dining",
    objectId: "gagarinsky",
    title: "Гостиная-столовая 33,6 м²",
    area: "33,6 м²",
    location: "Симферополь",
    year: "Сдан в марте 2026",
    style: "Современная роскошь: ручная роспись стен, благородный орех и латунные акценты",
    category: "residential",
    task: "Создать просторную гостиную-столовую 33,6 м², в которой большой масштаб и обилие премиальных материалов остаются по-домашнему уютными. Чётко зонировать столовую, лаундж и ТВ-зону, не перекрывая основные пути движения, и связать пространство с кухней общим стилистическим ансамблем.",
    status: "Реализован",
    description:
      "Гостиная-столовая 33,6 м² в ЖК «Гагаринский» — это пространство о воздухе, масштабе и ювелирной работе с деталями. Главным вызовом стало сохранить камерное ощущение в комнате с серьёзным метражом и набором премиальных материалов: дерево, латунь, велюр, ручная роспись. Композиция строится на двух акцентных стенах и продуманной геометрии мебели, которые удерживают пространство в едином ритме. " +
      "Особое место в отделке занимают обои с ручной росписью металлизированными чернилами — это не фоновое покрытие, а полноценное произведение искусства: каждая линия неповторима, а лёгкий металлический блеск меняется в зависимости от времени суток и сценария освещения. Графика летящих птиц превращается в визуальный символ всей квартиры и перекликается с золотистыми фасадами кухни, связывая две зоны в один стилистический ансамбль. " +
      "Обеденная группа собрана для семейных ужинов и приёма гостей: овальный стол на массивной рифлёной опоре из ореха, дизайнерские полукруглые кресла в бежевом велюре с латунными опорами и каскадная люстра из плетёных «дисков», которая работает визуальным центром столовой. Рядом — высокая витрина из брашированного ореха со стеклянными дверцами: парадная посуда и хрусталь становятся частью интерьера, а классический профиль фасада добавляет проекту неоклассической интонации. " +
      "В зоне гостиной — модульный угловой диван глубокого серого цвета. По требованию заказчика он развёрнут «углом к проходу»: это позволило сформировать приватную лаунж-капсулу, не перекрывая основные пути движения между прихожей, кухней и спальней. Журнальный столик с латунной столешницей и стеклянной ножкой, мягкий кремовый ковёр и крупный декор на стене собирают зону в спокойный, обволакивающий сценарий вечернего отдыха. " +
      "Медиа-стена решена как самостоятельный архитектурный объект: центральная панель из тёмного ореха с вертикальными латунными вставками и скрытой подсветкой по контуру выгодно подчёркивает мерцание металлизированных чернил на соседних плоскостях. Латунная каскадная люстра над лаунж-зоной перекликается с фурнитурой обеденных кресел, светильниками-подвесами и акцентами кухни — единая металлическая нить проходит через весь интерьер. " +
      "В результате — гостиная-столовая, в которой большой объём подан спокойно и тактично: каждая зона имеет собственный характер и сценарий, а художественные детали и игра света делают пространство узнаваемым с первого взгляда.",
    coverGradient: "from-primary/20 to-secondary/25",
    coverImage: gagLivImg02,
    gallery: [
      { src: gagLivImg02, alt: "Просторная и светлая обеденная зона с овальным столом из ореха, велюровыми креслами и классическим витринным шкафом" },
      { src: gagLivImg01, alt: "Обеденная зона и декор в виде птицы как символ концепции квартиры — настенный объект и фиолетовые портьеры" },
      { src: gagLivImg03, alt: "Высокая витрина из брашированного ореха со стеклянными фасадами и комфортные дизайнерские стулья в бежевой велюровой обивке" },
      { src: gagLivImg04, alt: "Тандем материалов и декора обеденной зоны и лаунж-зоны: ореховый стол, велюровые кресла и медиа-стена с птицами" },
      { src: gagLivImg05, alt: "ТВ-зона, декорированная обоями с ручной росписью золотыми птицами и панелью из ореха со скрытой подсветкой" },
      { src: gagLivImg06, alt: "Комфортабельный угловой диван серого цвета, развёрнутый углом к проходу, и латунная люстра-кольцо над лаунж-зоной" },
    ],
  },
  {
    id: "gagarinsky-hallway",
    objectId: "gagarinsky",
    title: "Прихожая и коридор 11,5 м²",
    area: "11,5 м²",
    location: "Симферополь",
    year: "Сдан в марте 2026",
    style: "Современная классика: молдинги, паркет «ёлочка», латунные акценты и магнитные треки",
    category: "residential",
    task: "Превратить вытянутый коридор 11,5 м² из транзитной зоны в эффектную «прелюдию» к основному интерьеру: задать тон всей квартире, спрятать максимум хранения и сохранить ощущение архитектурного объёма и высоты потолков.",
    status: "Реализован",
    description:
      "Прихожая и коридор 11,5 м² в ЖК «Гагаринский» — это парадная эстетика и тщательно скрытая функциональность. Несмотря на вытянутую форму, пространство выглядит свободным и архитектурным: безупречный порядок, благородные фактуры и графичные золотые акценты с первых шагов задают характер всему интерьеру. " +
      "Вдоль одной из стен размещена полноростовая система хранения — гардеробные шкафы с филёнчатыми фасадами в тон стен и тонкими латунными ручками-рейлингами. Часть фасадов решена по системе push-to-open и превращает мебель в монолитную плоскость, благодаря чему объём ощущается как продолжение архитектуры, а не как набор отдельных шкафов. В центральной нише между шкафами организована парадная зона с большим ростовым зеркалом в раме из молдингов и фацетом — символ гостеприимства, который встречает гостей и визуально удлиняет пространство. " +
      "Возле входной двери предусмотрена компактная мягкая банкетка на тонких латунных опорах — удобный сценарий «обуться/разуться» — и аккуратная открытая ниша для мелочей. Входная дверь в графитовом цвете с классическими филёнками работает спокойным акцентом на фоне светлых стен, а узкая вертикальная вставка обоев с золотыми журавлями подсказывает, что главная художественная идея квартиры начинается уже здесь. " +
          "Все межкомнатные двери в коридоре — высокие полотна с эффектом «невидимки»: они окрашены в насыщенный графитово-синий цвет, посажены заподлицо со стеной без наличников и дополнены тонкой чёрной горизонтальной вставкой. Такой приём не дробит пространство, подчёркивает высоту потолков и держит коридор в едином графичном ритме. " +
      "Освещение спроектировано как самостоятельный сценарий. Чёрные магнитные треки на потолке задают направление движения и позволяют точечно подсвечивать зоны шкафов, банкетки и зеркала. Контурная LED-подсветка по периметру зеркала создаёт эффект «парения» и работает как мягкий ночной свет, а классический плинтус и потолочные молдинги аккуратно собирают композицию в единый неоклассический каркас. На полу — тёмная дубовая «ёлочка», которая физически связывает прихожую с гостиной-столовой и продолжает общий ансамбль квартиры.",
    coverGradient: "from-primary/20 to-secondary/25",
    coverImage: gagHallImg01,
    gallery: [
      { src: gagHallImg01, alt: "Парадная зона прихожей: большое ростовое зеркало с фацетом в раме из молдингов, белые шкафы с латунными ручками и паркет «ёлочка»" },
      { src: gagHallImg02, alt: "Комфортная входная группа с графитовой входной дверью, мягкой банкеткой на латунных опорах и вставкой обоев с золотыми журавлями" },
      { src: gagHallImg03, alt: "Эргономичное и стильное место хранения: полноростовые шкафы с филёнчатыми фасадами и латунной фурнитурой, ниша с консолью у входа в столовую" },
      { src: gagHallImg04, alt: "Лаконичность и стиль: высокие межкомнатные двери-«невидимки» в графитово-синем цвете и магнитные треки на потолке" },
    ],
  },
  {
    id: "gagarinsky-kitchen",
    objectId: "gagarinsky",
    title: "Кухня 14,5 м²",
    area: "14,5 м²",
    location: "Симферополь",
    year: "Сдан в марте 2026",
    style: "Современная классика с золотыми акцентами: патагонский мрамор, эмалевые фасады и латунь",
    category: "residential",
    task: "Спроектировать функциональную кухню 14,5 м² как продолжение единого ансамбля квартиры: связать её с гостиной-столовой через общую палитру и материалы, дать максимум хранения «в потолок» и сделать камень главным художественным акцентом пространства.",
    status: "Реализован",
    description:
      "Кухня 14,5 м² в ЖК «Гагаринский» построена на эффектном контрасте между строгой геометрией классических фасадов и природным «хаосом» драгоценного камня. Главным героем интерьера стал патагонский мрамор (Patagonia) — его уникальная фактура с полупрозрачными включениями, крупными кристаллами и драматичными прожилками одновременно работает на фартуке, столешнице и барной стойке, превращая рабочую зону в настоящую художественную инсталляцию. " +
      "Гарнитур спроектирован «в потолок»: это визуально увеличивает высоту помещения и даёт максимум мест для хранения. Нижние фасады и высокие колонны для встроенной техники выполнены в сдержанном светло-сером оттенке с классическими филёнками и тонкими латунными ручками-рейлингами — они спокойно поддерживают рисунок камня и не перетягивают внимание. Верхний ярус и эффектная скруглённая вытяжка-«остров» решены в тёплом золотом цвете из крашенного МДФ (эмаль) с идеальным финишем: фасады мягко отражают свет и наполняют кухню тёплым сиянием, а отсутствие видимой фурнитуры подчёркивает монолитность и чистоту дизайна. " +
      "Барная стойка из массивной плиты патагонского мрамора служит консольным продолжением кухни и одновременно мягким зонированием с гостиной-столовой. Эргономичная планировка посадочных мест — два барных стула с торца и два сбоку — позволяет одновременно разместить семью за быстрым завтраком и оставить открытым проход. Над стойкой парит прозрачно-золотая люстра со стеклянными «капельными» подвесами: хрупкая графика этого светильника создаёт ощущение лёгкости и подчёркивает массивность каменной столешницы. " +
      "Сценарий освещения собран из нескольких слоёв: контурная LED-подсветка под верхними шкафами и над цоколем заставляет грани патагонского мрамора «играть» по-новому, точечные накладные споты на потолке аккуратно подсвечивают рабочую зону, а декоративная люстра отвечает за вечерний сценарий. На полу — паркет «ёлочка» из тёмного дуба, который физически связывает кухню с гостиной-столовой и прихожей и удерживает интерьер в едином ансамбле. Финальный штрих — концепция «золотых птиц», которая стартует на акцентной стене обеденной зоны и мягким эхом возвращается в декоре кухни, делая всю общественную часть квартиры единым художественным высказыванием.",
    coverGradient: "from-primary/20 to-secondary/25",
    coverImage: gagKitImg01,
    gallery: [
      { src: gagKitImg01, alt: "Кухня в ЖК «Гагаринский»: патагонский мрамор на фартуке и столешнице, серые филёнчатые фасады с латунными ручками и золотая скруглённая вытяжка" },
      { src: gagKitImg02, alt: "Рабочая зона кухни: эффектная вытяжка-«остров» в золотой эмали, фартук и столешница из патагонского мрамора, встроенная техника Bosch в чёрном цвете" },
      { src: gagKitImg03, alt: "Барная зона с массивной столешницей из патагонского мрамора и хрупкой золотой люстрой со стеклянными подвесами над стойкой" },
      { src: gagKitImg04, alt: "Вид сверху на барную стойку: эргономичная расстановка стульев на белой обивке вокруг каменной плиты с природными прожилками" },
      { src: gagKitImg05, alt: "Концепция «золотых птиц», объединяющая кухню, барную зону и гостиную-столовую в единый художественный ансамбль" },
    ],
  },
];
