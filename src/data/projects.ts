...
export const projects: Project[] = [
  {
    ...
    coverImage: thumbBalustradeViz1,
  ...
  },
  {
    ...
    coverImage: thumbHallwayZhigulina1,
    coverGradient: "from-primary/20 to-secondary/25",
    gallery: [
  ...
  },
  {
    ...
    coverImage: thumbMarbleKitchen1,
    gallery: [
  ...
  },
  {
    ...
    coverImage: thumbHolidayHouseLiving1,
    gallery: [
  ...
  },
  {
    ...
    coverImage: thumbCoffeeShopSimferopol1,
    gallery: [
  ...
  },
  {
    ...
    coverImage: thumbCompactBedroom1,
    gallery: [
