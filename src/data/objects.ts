...
export const curatedObjects: PortfolioObject[] = [
  ...
  },
  {
    ...
    category: "residential",
    intro:
      "Частный дом 100 м² за городом: интерьер для семьи меломанов и киноманов, где современная классика встречается с винилом, скрытым домашним кинотеатром и продуманной геометрией света.",
