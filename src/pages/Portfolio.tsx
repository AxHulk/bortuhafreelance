...
const Portfolio = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title="Портфолио дизайнера интерьеров — проекты в Крыму"
        description="Реализованные интерьеры квартир, домов и коммерции: спальни, кухни-гостиные, ванные, кабинеты. Современный, минимализм, лофт, скандинавский, классика. Симферополь, Севастополь, Ялта."
        path="/portfolio"
        jsonLd={[
          itemListJsonLd,
          breadcrumbJsonLd([
