...
const AiViz = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title="Нейровизуализация интерьеров — AI-рендеры за 3 часа, Крым"
        description="Экспресс AI-визуализация интерьеров, фасадов и общественных пространств для застройщиков, бизнеса и дизайнеров. Симферополь, Севастополь, Ялта — и онлайн по всей России."
        path="/ai-viz"
